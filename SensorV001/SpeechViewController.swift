...
class SpeechViewController: UIViewController {
    ...
    @IBAction func discardButtonPressed(_ sender: Any) {
        print("Just pressed DISCARD button")
        transcribedText.text=""
    }
    
    
    @IBAction func saveButtonPressed(_ sender: Any) {
        print("Just pressed SAVE button")
        let t = transcribedText.text ?? "<NULL>"
        print("About to save:",t)
        GoogleSheetsIntegration.recordFeedback(t)
        transcribedText.text=""
    }
    ...
    func getPermissions(){
        SFSpeechRecognizer.requestAuthorization{authStatus in
            OperationQueue.main.addOperation {
                switch authStatus {
                case .authorized:
                    print("Speech recognizer permissions: authorised..")
                default:
                    print("Speech recognizer permissions: none")
                }
            }
        }
    }
